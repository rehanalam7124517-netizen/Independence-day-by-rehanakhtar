...
const fighters = {
  ...
  kalam: {
    ...
    meta: {
      ...
      contributions: "Space and missile technology leadership and inspiration for youth through science and education",
      awards: "Bharat Ratna (1997)",
    },
    bio: [
      "Dr. A. P. J. Abdul Kalam became a symbol of scientific ambition, humility, and public service.",
      "He inspired millions of young Indians to dream beyond limits and work with purpose.",
      "His role in India’s missile and space programmes made him a national icon of excellence.",
      "He earned admiration for combining deep technical ability with a calm, approachable style.",
      "He strongly believed that science could transform the lives of ordinary people.",
      "Kalam ji used his influence to encourage students to think big and stay grounded.",
      "He connected innovation with national pride and future progress.",
      "His simple lifestyle and encouraging words made him beloved across generations.",
      "He remains a guiding figure for those who wish to serve the nation through knowledge.",
      "His legacy continues to light the path for young scientists and citizens alike.",
    ],
  },
  patel: {
